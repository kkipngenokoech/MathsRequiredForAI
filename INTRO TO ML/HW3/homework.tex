    ...
    \begin{center}
        ...
        \node {education level}
            child { node {University } 
                child { node {Relationship status}
                    child{ node {single}
                        child{node {phone usage - low - 3}}
                    }
                    child{node {Married}
                        child{node {high - 3}}
                    }
                    child{node {In a Relationship}}
                 }
            }
            child { node {College}
                child { node {medium - 5}}
...
\begin{table}[h!]
    ...
    \begin{enumerate}
        ...
        \end{tikzpicture}
        \\ if the person does practice social distancing and is handwashing 
