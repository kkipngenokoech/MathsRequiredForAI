...
\begin{enumerate}
    ...
    \item \begin{enumerate}
        \item All cyclic graphs are complete graphs
        \item All complete graphs are cyclic graphs
        \item All paths are bipartite.
        \item There are cyclic graphs which are complete
    \end{enumerate}
    \item Which of the following statements for a simple graph is correct.
    \begin{enumerate}
        \item Every trail is a path
