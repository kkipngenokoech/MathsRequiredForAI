...
\]
so, $\gamma_{51} = \textbf{0.000013}, \quad \gamma_{52} = \textbf{0.999987}$
\\ for x = 8:
\\ we find the PMFs:
\[
...
\[
\mu_1 = \frac{\sum_{i=1}^{n} \gamma_{i1} X_i}{\sum_{i=1}^{n} \gamma_{i1}} = \frac{1 \times 1 + 0.999987 \times 2 + 0.99943 \times 3 + 0.00055 \times 6 + 0.000013 \times 7 + 0 \times 8}{1 + 0.999987 + 0.99943 + 0.00055 + 0.000013 + 0}
\]
\[
\mu_1 = \frac{1 + 1.999974 + 2.99829 + 0.0033 + 0.000091 + 0}{3.999974} = \frac{6.001655}{2.999974} = \textbf{2.000643}
\]
\[
\mu_2 = \frac{\sum_{i=1}^{n} \gamma_{i2} X_i}{\sum_{i=1}^{n} \gamma_{i2}} = \frac{0 \times 1 + 0.000013 \times 2 + 0.00055 \times 3 + 0.99943 \times 6 + 0.999987 \times 7 + 1 \times 8}{0 + 0.000013 + 0.00055 + 0.99943 + 0.999987 + 1}
\]
\[
\mu_2 = \textbf{6.999440951707624}
\]
\[
\sigma_1^2 = \frac{\sum_{i=1}^{n} \gamma_{i1} (X_i - \mu_1)^2}{\sum_{i=1}^{n} \gamma_{i1}} = \frac{1 \times (1 - 2.000643)^2 + 0.999987 \times (2 - 2.000643)^2 + 0.99943 \times (3 - 2.000643)^2 + 0.00055 \times (6 - 2.000643)^2 + 0.000013 \times (7 - 2.000643)^2 + 0 \times (8 - 2.000643)^2}{1 + 0.999987 + 0.99943 + 0.00055 + 0.000013 + 0}
\]
\[
\sigma_1^2 = \textbf{ 0.669461595593554}
\]
\[
\sigma_2^2 = \frac{\sum_{i=1}^{n} \gamma_{i2} (X_i - \mu_2)^2}{\sum_{i=1}^{n} \gamma_{i2}} = \frac{0 \times (1 - 6.999440951707624)^2 + 0.000013 \times (2 - 6.999440951707624)^2 + 0.00055 \times (3 - 6.999440951707624)^2 + 0.99943 \times (6 - 6.999440951707624)^2 + 0.999987 \times (7 - 6.999440951707624)^2 + 1 \times (8 - 6.999440951707624)^2}{0 + 0.000013 + 0.00055 + 0.99943 + 0.999987 + 1}
\]
\[
\sigma_2^2 = \textbf{0.6694615955935538}
\]
\[
\pi_1 = \frac{1}{n} \sum_{i=1}^{n} \gamma_{i1} = \frac{1 + 0.999987 + 0.99943 + 0.00055 + 0.000013 + 0}{6} = \frac{2.00098}{6} = \textbf{0.5}
\]
\[
\]
so, the updated parameters after the first iteration are:
\[
\mu_1 = 3.99999, \quad \mu_2 = 6.00001, \quad \sigma_1^2 = 2.00001, \quad \sigma_2^2 = 1.00001, \quad \pi_1 = 0.66665, \quad \pi_2 = 0.33335
\]
