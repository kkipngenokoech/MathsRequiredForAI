...
\section{For my own revision}

This helps us to calculate the probability of an event by considering all the possible outcomes it could take. let us say: it could rain whether it is cloudy or clear. The probability of rain is the sum of the probability of rain given it is cloudy and the probability of rain given it is clear.\newline

Another example is that a student can pass a test if they study or not. The probability of passing the test is the sum of the probability of passing the test given they studied and the probability of passing the test given they did not study.\newline

so in general the law of total probability is given by: \(P(A) = P(A|B_1)P(B_1) + P(A|B_2)P(B_2) + \ldots + P(A|B_n)P(B_n)\) \newline
