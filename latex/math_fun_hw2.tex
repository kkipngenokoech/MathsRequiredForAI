...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \]
        \[
            \text{The kernel of } T \text{ is the set of all vectors that are mapped to the zero vector} = \begin{pmatrix} 0 \\ 0 \\ 0 \end{pmatrix} = \begin{pmatrix} 4 & -2 \\ 1 & 5 \\ 0 & 2 \end{pmatrix} \begin{pmatrix} x \\ y \end{pmatrix} = \begin{pmatrix} 4x - 2y \\ x + 5y \\ 2y \end{pmatrix} = \begin{pmatrix} 0 \\ 0 \\ 0 \end{pmatrix}
        \]
    ...
    \begin{enumerate}
        ...
        \]
        \[
            \text{ Therefore, the limit as } n \to \infty \text{ of the matrices } A^n \text{ is } \lim_{n \to \infty} A^n = \begin{pmatrix} 0 & 1 \\ 0 & 1 \end{pmatrix}
        \]
    \end{enumerate}
